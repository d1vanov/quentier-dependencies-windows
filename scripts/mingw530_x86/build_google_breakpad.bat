...
C:\cygwin\bin\bash -lc "sed -i '23s#sh scripts/appveyor-gcc.sh#export PATH=/cygdrive/c/MinGW/bin:$PATH; export CC=/cygdrive/c/MinGW/bin/gcc.exe; export CXX=/cygdrive/c/MinGW/bin/g++.exe; sh scripts/appveyor-gcc.sh# /cygdrive/c/dev/breakpad/scripts/appveyor.bat"
