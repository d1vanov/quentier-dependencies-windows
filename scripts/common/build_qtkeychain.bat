...
if not %build_tool%==mingw cmake .. -G %MAKEFILES% -DCMAKE_BUILD_TYPE=RelWithDebInfo -DUSE_CREDENTIAL_STORE=OFF -DBUILD_TEST_APPLICATION=OFF -DCMAKE_INSTALL_PREFIX="c:\dev\qtkeychain\build\installdir" -DCMAKE_PREFIX_PATH="C:/Qt/5.13/%qt%" -DCMAKE_CXX_FLAGS="/wd4365 /wd4464 /wd4571 /wd4577 /wd4619 /wd4625 /wd4626 /wd4668 /wd4710 /wd4774 /wd4820 /wd4946 /wd5026 /wd5027"
